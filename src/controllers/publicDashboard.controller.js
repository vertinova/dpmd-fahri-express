...
const buildPublicDashboardPayload = async (req) => {
  ...
  const [
    ...
    safeBuildModule('wilayah detail', () => buildWilayahDetail(), {
      total_kecamatan: totalKecamatan,
      total_desa: totalDesa,
      total_kelurahan: totalKelurahan,
      records: []
    }),
    safeBuildModule('profil desa detail', () => buildProfilDesaDetail(baseUrl), {
      total_terisi: totalProfilDesa,
      total_desa: totalDesa,
      records: []
    }),
    safeBuildModule('produk hukum detail', () => buildProdukHukumDetail(baseUrl), {
    ...
    safeBuildModule('aparatur desa detail', () => buildAparaturDesaDetail(baseUrl), {
      total: totalAparaturLokal,
      aktif: totalAparaturLokal,
      records: []
    }),
    safeBuildModule('bumdes detail', () => buildBumdesDetail(baseUrl), {
      total: totalBumdes,
      aktif: bumdesAktif,
    ...
    safeBuildModule('kelembagaan detail', () => buildKelembagaanDetail(baseUrl), {
    ...
    safeBuildModule('bankeu detail', () => buildBankeuDetail(baseUrl), {
